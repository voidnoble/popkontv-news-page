(function() {
    ...
    MainController.$inject = ['$scope', '$http', '$location', '$q', 'MainFeatureFactory', 'IssueFactory'];
     ...
     * @param $http
     */
    function MainController($scope, $http, $location, $q, MainFeatureFactory, IssueFactory)
    {
        var vm = this;
